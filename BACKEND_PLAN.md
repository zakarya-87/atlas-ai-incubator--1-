...
| **Authentication** | **Supabase Auth** or **Passport.js (JWT)** | We will use **JWT via Passport.js** to maintain control, or Supabase for speed. *Recommendation: JWT/Passport for custom role management.* |
