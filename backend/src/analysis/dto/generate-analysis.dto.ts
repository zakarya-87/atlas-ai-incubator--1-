...
export class GenerateAnalysisDto {
  @ApiProperty({ description: 'UUID of the Venture context', example: 'v123-456' })
  @IsString()
  @IsNotEmpty()
  ventureId: string;
  ...
  @ApiProperty({ description: 'User input describing the business', example: 'A subscription coffee service.' })
  @IsString()
  @IsNotEmpty()
  description: string;
  ...
  @ApiPropertyOptional({ description: 'JSON Schema for the response structure' })
  @IsObject()
  @IsOptional()
  responseSchema?: any;

  @ApiPropertyOptional({ description: 'Base64 encoded images for multi-modal analysis' })
  @IsArray()
  @IsOptional()
  images?: string[];

  @ApiPropertyOptional({ description: 'Instruction to refine an existing analysis' })
  @IsString()
  @IsOptional()
