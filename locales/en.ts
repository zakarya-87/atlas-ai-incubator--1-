export const en = {
  ...
  // Tooltips
  tooltipDashboard: 'Home & Overview',
  tooltipStrategy: 'Strategic Planning Tools',
  tooltipMarketAnalysis: 'Market Research & Insights',
  tooltipFundamentals: 'Idea Validation & Basics',
  tooltipFinance: 'Financial Modeling & Forecasts',
  tooltipGrowth: 'Scaling & Milestones',
  tooltipFunding: 'Pitch Decks & Investors',
  tooltipArchitecture: 'System Architecture',
  tooltipAudit: 'History & Logs',
  tooltipIntegrations: 'Connect External Apps',
  tooltipProductivity: 'Task Management & Tools',
  tooltipStartTour: 'Start Onboarding Tour',
  tooltipShare: 'Share Project',

  // Sidebar
  sidebarDashboard: 'Dashboard',
  sidebarFundamentals: 'Fundamentals',
  sidebarStrategy: 'Strategy',
  sidebarMarketAnalysis: 'Market Analysis',
  sidebarFinance: 'Finance',
  sidebarGrowth: 'Growth',
  sidebarFunding: 'Funding',
  sidebarProductivity: 'Productivity',
  sidebarIntegrations: 'Integrations',
  sidebarArchitecture: 'Architecture',
  sidebarAuditTrail: 'Audit Trail',
  ...
  dashboardNoActivity: 'No recent analyses found. Start building!',
  ...
  strategyNavPestel: 'PESTEL Analysis',
  strategyNavRoadmap: 'Roadmap Builder',
  strategyNavLeanCanvas: 'Lean Canvas',
  strategyNavOkrWorkflow: 'Goal-Setting & OKR',
  marketAnalysisNavOverview: 'Market Overview',
  marketAnalysisNavResearch: 'In-Depth Research',
  fundamentalsNavIdeaValidation: 'Idea Validation',
  fundamentalsNavProblemValidation: 'Problem Validation',
  fundamentalsNavCompetitorAnalysis: 'Competitor Analysis',
  fundamentalsNavCustomerValidation: 'Customer Validation',
  fundamentalsNavRiskFeasibility: 'Risk & Feasibility',
  fundamentalsNavValidationTracker: 'Learning & Tracking',
  fundamentalsNavExperimentBuilder: 'Experiment Builder',
  fundamentalsNavBrandIdentity: 'Brand Identity',
  financeNavBudgetGenerator: 'Budget Generator',
  financeNavFinancialForecast: 'Financial Forecast',
  financeNavCashFlowForecast: 'Cash Flow Forecast',
  financeNavKpiDashboards: 'KPI Dashboards',
  growthNavMilestones: 'Milestones & Alerts',
  growthNavExpansionStrategy: 'Expansion Strategy',
  fundingNavPitchDeckGenerator: 'Pitch Deck Generator',
  fundingNavInvestorDatabase: 'Investor Database',
  fundingNavFundraisingRoadmap: 'Fundraising Roadmap',
  architectureNavSystemDesign: 'System Design',
  productivityNavTaskManager: 'Task Manager',

  // Module Placeholder
  buttonExplore: 'Explore Module',
  strategyModuleTitle: 'Strategy Module',
  strategyModuleDescription: 'Develop your strategic plan.',
  marketAnalysisModuleTitle: 'Market Analysis Module',
  marketAnalysisModuleDescription: 'Analyze the market.',
  fundamentalsModuleTitle: 'Fundamentals Module',
  fundamentalsModuleDescription: 'Validate your ideas.',
  financeModuleTitle: 'Finance Module',
  financeModuleDescription: 'Plan your financials.',
  growthModuleTitle: 'Growth Module',
  growthModuleDescription: 'Scale your business.',
  fundingModuleTitle: 'Funding Module',
  fundingModuleDescription: 'Get funded.',
  architectureModuleTitle: 'Architecture Module',
  architectureModuleDescription: 'System architecture.',
  auditModuleTitle: 'Audit Module',
  auditModuleDescription: 'Audit trail.',
  integrationsModuleTitle: 'Integrations Module',
  integrationsModuleDescription: 'Manage integrations.',
  productivityModuleTitle: 'Productivity Module',
  productivityModuleDescription: 'Boost productivity.',
  ...
  inputQualityWeak: 'Weak (Too short)',
  inputQualityFair: 'Fair',
  inputQualityGood: 'Good',
  ...
  pestelSocial: 'Social',
  pestelTechnological: 'Technological',
  pestelEnvironmental: 'Environmental',
  pestelLegal: 'Legal',

  marketTargetAudience: 'Target Audience',
  marketSizeAndTrends: 'Market Size & Trends',
  marketCompetitorLandscape: 'Competitor Landscape',
  marketResearchDrivers: 'Market Drivers',
  marketResearchCustomerBehavior: 'Customer Behavior',
  marketResearchBarriersToEntry: 'Barriers to Entry',

  leanCanvasProblem: 'Problem',
  leanCanvasSolution: 'Solution',
  leanCanvasKeyMetrics: 'Key Metrics',
  leanCanvasUniqueValueProposition: 'Unique Value Proposition',
  leanCanvasUnfairAdvantage: 'Unfair Advantage',
  leanCanvasChannels: 'Channels',
  leanCanvasCustomerSegments: 'Customer Segments',
  leanCanvasCostStructure: 'Cost Structure',
  leanCanvasRevenueStreams: 'Revenue Streams',

  ideaValidationSummary: 'Executive Summary',
  ideaValidationProblemStatement: 'Problem Statement',
  ideaValidationSolutionStatement: 'Solution Statement',
  ideaValidationValueProposition: 'Value Proposition',
  ideaValidationKeyAssumptions: 'Key Assumptions',

  problemValidationMarketSize: 'Market Size Estimation',
  problemValidationTAM: 'Total Addressable Market (TAM)',
  problemValidationSAM: 'Serviceable Available Market (SAM)',
  problemValidationSOM: 'Serviceable Obtainable Market (SOM)',
  problemValidationCustomerSegments: 'Customer Segments',
  problemValidationProblemSignificance: 'Problem Significance',

  competitorAnalysisMap: 'Competitor Landscape Map',
  competitorAnalysisHeaderName: 'Name',
  competitorAnalysisHeaderType: 'Type',
  competitorAnalysisHeaderFeatures: 'Key Features',
  competitorAnalysisHeaderPricing: 'Pricing Model',
  competitorAnalysisHeaderPositioning: 'Positioning',
  competitorAnalysisGaps: 'Market Gaps',
  competitorAnalysisDifferentiators: 'Differentiators',
  competitorAnalysisRisks: 'Competitive Risks',

  customerValidationScorecard: 'Validation Scorecard',
  customerValidationLandingPage: 'Landing Page Concept',
  customerValidationAds: 'Ad Copy Examples',
  customerValidationSurvey: 'Survey Questions',

  riskFeasibilityScore: 'Feasibility Score',
  riskFeasibilityResources: 'Resource Estimates',
  riskFeasibilityRegulatory: 'Regulatory Risks',
  riskFeasibilityFinancial: 'Financial Risks',
  riskFeasibilityOperational: 'Operational Risks',

  validationTrackerKeyMetrics: 'Live Metrics Tracking',
  validationTrackerCompetitorActivity: 'Competitor Activity Feed',
  validationTrackerEmergingTrends: 'Emerging Trends',
  validationTrackerFundingInsights: 'Funding Insights',

  okrWorkflowVision: 'Vision Statement',
  okrWorkflowStrategicGoals: 'Strategic Goals',
  okrWorkflowCascadingAlignment: 'Cascading Alignment',
  okrWorkflowTracking: 'Tracking & Review',
  okrWorkflowReflection: 'Reflection & Next Cycle',

  budgetGeneratorSummary: 'Budget Summary',
  budgetGeneratorScenarios: 'Scenarios Overview',
  budgetGeneratorScenario: 'Scenario',
  budgetGeneratorTotalRevenue: 'Total Revenue',
  budgetGeneratorTotalExpenses: 'Total Expenses',
  budgetGeneratorNetProfitLoss: 'Net Profit/Loss',
  budgetGeneratorBreakdown: 'Detailed Breakdown',
  budgetGeneratorItem: 'Item',
  budgetGeneratorType: 'Type',
  budgetGeneratorAmount: 'Amount (Yearly)',
  budgetGeneratorRecommendations: 'AI Recommendations',

  financialForecastTitle: '5-Year Financial Forecast',
  financialForecastReset: 'Reset',
  financialForecastSaveVersion: 'Save Version',
  financialForecastProjections: 'Projections Table',
  financialForecastYear: 'Year',
  financialForecastRevenue: 'Revenue',
  financialForecastCOGS: 'COGS',
  financialForecastGrossProfit: 'Gross Profit',
  financialForecastOPEX: 'OPEX',
  financialForecastNetProfit: 'Net Profit',
  financialForecastAssumptions: 'Adjust Assumptions',

  cashFlowForecastTitle: '12-Month Cash Flow Forecast',
  cashFlowForecastRunway: 'Estimated Runway',
  cashFlowForecastMonths: 'Months',
  cashFlowForecastBurnRate: 'Avg. Burn Rate',
  cashFlowForecastMonthlyView: 'Monthly View',
  cashFlowForecastMonth: 'Month',
  cashFlowForecastInflows: 'Inflows',
  cashFlowForecastOutflows: 'Outflows',
  cashFlowForecastNetFlow: 'Net Flow',
  cashFlowForecastEndBalance: 'End Balance',
  cashFlowForecastInsights: 'Cash Flow Insights',

  kpiDashboardTitle: 'Key Performance Indicators',
  kpiDashboardExecutiveSummary: 'Executive Summary',

  milestonesRoadmap: 'Strategic Roadmap',
  milestonesSmartAlerts: 'Smart Alerts',

  expansionStrategyRecommended: 'Recommended Strategy',
  expansionStrategyMarket: 'Market Expansion Suggestions',
  expansionStrategyModeling: 'Predictive Modeling Insights',
  expansionStrategyPartnerships: 'Partnership Recommendations',

  pitchDeckTitle: 'Pitch Deck Slides',
  pitchDeckVisualSuggestion: 'Visual Suggestion',

  investorMatchingTitle: 'Investor Matching',
  investorMatchingFilters: 'Filters',
  investorMatchingFilterType: 'All Types',
  investorMatchingFilterStage: 'All Stages',
  investorMatchingFilterSector: 'Filter by Sector...',
  investorMatchingSortByAlignment: 'Sort by Alignment',
  investorMatchingOutreachButton: 'Draft Outreach',
  investorMatchingNoResults: 'No investors found matching your criteria.',
  investorMatchingOutreachTitle: 'Investor Outreach Draft',
  investorMatchingClose: 'Close',

  fundraisingRoadmapTitle: 'Fundraising Roadmap',
  fundraisingRoadmapTimeline: 'Execution Timeline',
  fundraisingRoadmapAlerts: 'Strategic Alerts',
  fundraisingRoadmapAlternatives: 'Alternative Funding Options',

  experimentBuilderSaveBoard: 'Save Board',
  experimentBuilderColumnHypotheses: 'Hypotheses',
  experimentBuilderColumnMethods: 'Methods',
  experimentBuilderColumnMetrics: 'Metrics',
  experimentBuilderCardPlaceholder: 'New Item...',
  experimentBuilderCancel: 'Cancel',
  experimentBuilderSave: 'Save',
  experimentBuilderAddCard: 'Add Card',

  taskManagerTitle: 'Task Manager',
  taskManagerAddPlaceholder: 'Add a new task...',
  taskManagerAddButton: 'Add',
  taskManagerNoTasks: 'No tasks yet. Add one above!',
  ...
  exportAsPdf: 'Quick Export (Screenshot)',
  exportAsOfficialPdf: 'Download Official Report (PDF)',
  exportAsCsv: 'Export as CSV',
  exportAsMarkdown: 'Export as Markdown',

  // Sources
  sourcesVerifiedTitle: 'Verified Sources & Citations',

  auditTrailTitle: 'Audit Trail',
  auditTrailNoHistory: 'No history found.',
  auditTrailFilterByModule: 'Filter by Module',
  ...
  agentLogGeneratingInsights: 'Generating actionable insights...',
  agentLogFinalizingOutput: 'Finalizing report and formatting output...',
  ...
  shareModalInputLabel: 'Email Address',
  shareModalInputPlaceholder: 'colleague@example.com',
  shareModalSelectRole: 'Select Role',
  shareModalRoleContributor: 'Contributor',
  shareModalRoleReviewer: 'Reviewer',
  shareModalButtonInvite: 'Send Invite',
  ...
  tourOutputContent: 'Your generated analysis will appear here.',
  tourExportTitle: 'Export',
  tourExportContent: 'Download your results as PDF or CSV.',
  tourSearchTitle: 'Search',
  tourSearchContent: 'Quickly find any tool by name.',
  tourLanguageTitle: 'Language',
  tourLanguageContent: 'Switch between English, French, and Arabic.',
  tourEndTitle: 'Ready to Launch?',
  tourEndContent: 'You are all set. Start building your venture!',
  tourSkip: 'Skip Tour',
  tourPrev: 'Previous',
  tourNext: 'Next',
  tourDone: 'Finish',
