...
const icons = {
  drivers: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" /></svg>,
  behavior: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.658-.463 1.243-1.117 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.117 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" /></svg>,
  barriers: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" /></svg>,
};
...
const MarketResearchDisplay: React.FC<MarketResearchDisplayProps> = ({ data }) => {
  const { t } = useLanguage();

  const sections: { key: keyof MarketResearchData; titleKey: TranslationKey; icon: React.ReactNode; colors: string[] }[] = [
    { key: 'marketDrivers', titleKey: 'marketResearchDrivers', icon: icons.drivers, colors: ['bg-green-500/5', 'text-green-400'] },
    { key: 'customerBehavior', titleKey: 'marketResearchCustomerBehavior', icon: icons.behavior, colors: ['bg-blue-500/5', 'text-blue-400'] },
    { key: 'barriersToEntry', titleKey: 'marketResearchBarriersToEntry', icon: icons.barriers, colors: ['bg-red-500/5', 'text-red-400'] },
  ];
