            ...
            <form onSubmit={handleInvite} className="p-6 space-y-4">
              <div>
                <label
                  ...
                  className="block text-sm font-semibold mb-1 text-brand-light"
                >
              ...
              <div>
                ...
                >
                  <option value="contributor">
                    {t('shareModalRoleContributor')}
                  </option>
                  <option value="reviewer">
                    {t('shareModalRoleReviewer')}
                  </option>
                </select>
              </div>
              ...
              <div className="pt-2 flex justify-end items-center gap-4">
                <button
                  ...
                  onClick={onClose}
                  disabled={isSending}
                  className="px-4 py-2 text-sm text-brand-light hover:text-white rounded-md hover:bg-brand-accent/50 transition-colors disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={isSending}
                  className="px-6 py-2 text-sm bg-brand-teal rounded-md text-white font-semibold hover:bg-teal-500 transition-colors disabled:opacity-70 flex items-center"
                >
                  {isSending && (
                    <svg
