...
const navigationConfig: NavItemConfig[] = [
  {
    ...
    iconKey: 'dashboard',
    tooltipKey: 'tooltipDashboard',
  },
  {
    key: 'fundamentals',
    labelKey: 'sidebarFundamentals',
    iconKey: 'fundamentals',
    tooltipKey: 'tooltipFundamentals',
  },
  {
    key: 'strategy',
    labelKey: 'sidebarStrategy',
    iconKey: 'strategy',
    tooltipKey: 'tooltipStrategy',
  },
  {
    key: 'marketAnalysis',
    labelKey: 'sidebarMarketAnalysis',
    iconKey: 'marketAnalysis',
    tooltipKey: 'tooltipMarketAnalysis',
  },
  {
    key: 'finance',
    labelKey: 'sidebarFinance',
    iconKey: 'finance',
    tooltipKey: 'tooltipFinance',
  },
  {
    key: 'growth',
    labelKey: 'sidebarGrowth',
    iconKey: 'growth',
    tooltipKey: 'tooltipGrowth',
  },
  {
    key: 'funding',
    labelKey: 'sidebarFunding',
    iconKey: 'funding',
    tooltipKey: 'tooltipFunding',
  },
  {
    key: 'productivity',
    labelKey: 'sidebarProductivity',
    iconKey: 'productivity',
    tooltipKey: 'tooltipProductivity',
  },
  {
    key: 'integrations',
    labelKey: 'sidebarIntegrations',
    ...
    <button
      ...
      className={`flex flex-col items-center justify-center space-y-1 p-2 rounded-lg transition-colors duration-200 group w-full ${
        active
          ...
          : 'text-brand-light hover:bg-brand-accent/30'
      }`}
  ...
  ({ activeModule, onModuleChange }) => {
    ...
    return (
      <>
        ...
        <div
          id="sidebar-nav"
          className="hidden md:flex flex-col w-20 bg-brand-secondary/80 backdrop-blur-md border-r border-white/5 h-[calc(100vh-4rem)] fixed top-16 left-0 rtl:left-auto rtl:right-0 rtl:border-r-0 rtl:border-l overflow-y-auto py-4 z-40 transition-all duration-300"
        >
        ...
        <nav
          role="navigation"
          className="md:hidden fixed bottom-0 left-0 right-0 bg-brand-secondary/90 backdrop-blur-lg border-t border-white/10 z-50 pb-safe"
        >
