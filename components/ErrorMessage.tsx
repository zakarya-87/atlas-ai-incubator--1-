...
const ErrorMessage: React.FC<ErrorMessageProps> = ({ code, message, onRetry, isRetrying }) => {
  const { t } = useLanguage();
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center p-6 rounded-lg w-full max-w-lg mx-auto ${errorConfig.colorClasses}`}>
      {errorConfig.icon}
