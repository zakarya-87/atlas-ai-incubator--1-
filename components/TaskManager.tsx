  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-8 bg-brand-secondary/30 p-6 rounded-xl border border-brand-accent/30">
        <h2 className="text-3xl font-bold text-brand-teal mb-4">{t('taskManagerTitle')}</h2>
      ...
      <div className="space-y-3">
        <AnimatePresence mode="popLayout">
          {tasks.length > 0 ? (
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <span className={`text-lg transition-all duration-200 ${
                    task.completed ? 'text-brand-light line-through decoration-brand-teal/50' : 'text-brand-text'
                  }`}>
                    {task.text}
                  </span>
                </div>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto mb-4 text-brand-accent/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
