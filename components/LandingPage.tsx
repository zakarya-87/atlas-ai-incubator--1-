...
import {
  HiMenu, HiX, HiArrowRight, HiCheckCircle,
...
const LandingPage: React.FC<LandingPageProps> = ({ onSignIn }) => {
  ...
  const tools = [
    ...
    { icon: <MdOutlineTrackChanges className="w-6 h-6 text-[#00A896]" />, title: 'Competitor Intelligence', desc: 'AI-powered competitive landscape analysis' },
    { icon: <MdTrendingUp className="w-6 h-6 text-[#00A896]" />, title: 'Financial Modeling', desc: 'Revenue projections and burn rate planning' },
    { icon: <MdPalette className="w-6 h-6 text-[#00A896]" />, title: 'Brand Identity', desc: 'Logo concepts, color systems, and voice' },
    { icon: <MdAttachMoney className="w-6 h-6 text-[#00A896]" />, title: 'Funding Strategy', desc: 'Investor targeting and pitch optimization' },
    { icon: <HiCheckCircle className="w-6 h-6 text-[#00A896]" />, title: 'Problem Validation', desc: 'Evidence-based problem-solution fit' },
  ];

  return (
    <div className="min-h-screen bg-[#0D1B2A] text-[#E0E1DD] font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div
            ...
            style={{ width: 700, height: 700, top: '-5%', left: '-5%', filter: 'blur(130px)', background: 'radial-gradient(circle, rgba(0,168,150,0.22) 0%, transparent 70%)', animation: 'orb1 22s ease-in-out infinite' }}
          />
          <div
            className="absolute rounded-full pointer-events-none"
            style={{ width: 600, height: 600, top: '5%', right: '-8%', filter: 'blur(110px)', background: 'radial-gradient(circle, rgba(0,80,255,0.14) 0%, transparent 70%)', animation: 'orb2 18s ease-in-out infinite' }}
          />
          <div
            className="absolute rounded-full pointer-events-none"
            style={{ width: 800, height: 800, bottom: '-20%', left: '25%', filter: 'blur(150px)', background: 'radial-gradient(circle, rgba(0,168,150,0.16) 0%, transparent 65%)', animation: 'orb3 26s ease-in-out infinite' }}
          />
          <div
            className="absolute rounded-full pointer-events-none"
            style={{ width: 500, height: 500, top: '35%', left: '5%', filter: 'blur(120px)', background: 'radial-gradient(circle, rgba(60,0,180,0.10) 0%, transparent 70%)', animation: 'orb4 14s ease-in-out infinite' }}
          />
          <div
            className="absolute rounded-full pointer-events-none"
            style={{ width: 300, height: 300, top: '30%', right: '20%', filter: 'blur(80px)', background: 'radial-gradient(circle, rgba(0,200,180,0.25) 0%, transparent 70%)', animation: 'orb5 10s ease-in-out infinite' }}
          />

          <div
            className="absolute pointer-events-none"
            style={{ inset: '-60px', backgroundImage: 'linear-gradient(rgba(224,225,221,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(224,225,221,0.03) 1px, transparent 1px)', backgroundSize: '72px 72px', animation: 'gridDrift 30s ease-in-out infinite' }}
          />
          ...
          {[
            ...
            <div
              key={i}
              className="absolute rounded-full pointer-events-none"
              style={{ top: p.top, left: p.left, width: p.size, height: p.size, background: '#00A896', boxShadow: `0 0 ${p.size * 4}px rgba(0,168,150,0.8)`, animation: p.anim, animationDelay: p.delay }}
            />
          ))}

          <div
            className="absolute left-0 right-0 h-[2px] pointer-events-none"
            style={{ background: 'linear-gradient(90deg, transparent, rgba(0,168,150,0.15), transparent)', animation: 'scanLine 12s linear infinite' }}
          />
      ...
      <section className="bg-[#1B263B] py-8 border-y border-[#415A77]/30 relative z-20">
        <div className="max-w-7xl mx-auto px-4 overflow-hidden">
          <div className="flex items-center justify-start sm:justify-center gap-4 sm:gap-8 overflow-x-auto pb-4 sm:pb-0">
            {['Market Intelligence', 'Competitor Analysis', 'Financial Modeling', 'Brand Identity', 'Funding Strategy', 'Problem Validation'].map((feature, i, arr) => (
              <div key={i} className="flex-none flex items-center gap-2 sm:gap-4 whitespace-nowrap">
                ...
                {i < arr.length - 1 && <div className="w-1.5 h-1.5 rounded-full bg-[#415A77] hidden sm:block"></div>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="how-it-works" className="py-24 bg-[#0D1B2A] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
            ...
            {[
              { icon: <HiChatAlt className="w-10 h-10" />, step: 1, title: 'Describe Your Venture', desc: 'Input your core concept, target audience, and initial hypothesis in plain language.' },
              { icon: <MdPsychology className="w-10 h-10" />, step: 2, title: 'AI Agents Analyze', desc: '23 specialized AI agents collaborate to validate, model, and research your market.' },
              { icon: <HiDocumentText className="w-10 h-10" />, step: 3, title: 'Receive Structured Reports', desc: 'Get comprehensive, actionable business plans, financial models, and pitch materials.' },
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">
                23 AI-Powered Tools,<br /><span className="text-[#778DA9]">One Platform</span>
              </h2>
      ...
      <section className="py-20 bg-[#0A141F] border-y border-white/5 relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center divide-x divide-white/5">
            {[
              { value: '500+', label: 'Ventures Analyzed' },
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-[#1B263B] border border-[#415A77] rounded-3xl p-8 flex flex-col hover:border-[#778DA9] transition-colors">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                {['5 analysis credits per month', 'Core validation tools', 'Community access'].map((item) => (
                ...
                <li className="flex items-start gap-3 text-[#778DA9]">
                  <HiX className="w-5 h-5 shrink-0 mt-0.5" /> Export reports
                </li>
              </ul>
              <button
                onClick={onSignIn}
            ...
            <div className="bg-[#1B263B] border border-[#00A896] rounded-3xl p-8 flex flex-col relative shadow-[0_0_40px_rgba(0,168,150,0.15)] md:-translate-y-4">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                {['Unlimited analyses', 'All 23 AI tools', 'Priority AI processing', 'Export full reports (PDF/Doc)', 'Team collaboration (up to 3)'].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="text-[#415A77] text-sm">&copy; 2026 ATLAS AI Incubator.</div>
            </div>

            {[
              { heading: 'Product', links: ['Features', 'Pricing', 'API Reference', 'Roadmap'] },
              { heading: 'Resources', links: ['Documentation', 'Blog', 'Strategic Guides', 'Example Ventures'] },
