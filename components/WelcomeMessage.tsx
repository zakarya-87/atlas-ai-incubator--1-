...
const WelcomeMessage: React.FC<WelcomeMessageProps> = ({ activeTool }) => {
  ...
  let titleKey: TranslationKey = 'welcomeTitleSwot';
  let textKey: TranslationKey = 'welcomeTextSwot';
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.287 8.287 0 0 0 3.962-2.558 8.252 8.252 0 0 1 2.4-2.83Z"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 18a3.75 3.75 0 0 0 .495-7.468 3.75 3.75 0 0 0-7.99 0 3.75 3.75 0 0 0 .495 7.468Z"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-1.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25A2.25 2.25 0 0 1 5.25 3h9.75a2.25 2.25 0 0 1 2.25 2.25Z"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c-1.421-.62-2.897-1.59-4.07-2.848m11.54 5.698c1.173-1.258 2.649-2.228 4.07-2.848a7.5 7.5 0 0 0-7.5 0m7.5 0a7.5 7.5 0 0 1-7.5 0m0 0c-1.421.62-2.897 1.59-4.07 2.848m11.54-5.698a12.06 12.06 0 0 0-4.5 0m3.75 2.311a7.5 7.5 0 0 0-7.5 0"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 9.75v.015m0 3.735v.015m0 3.735v.015m3.75-5.25v.015m-7.5 0v.015m7.5 0v.015m0 3.735v.015m-7.5 0v.015m7.5 0v.015M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M2.25 18 9 11.25l3 3L21.75 6"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M21 15v6m0 0h-6m6 0-8-8"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M12 18V5.25m-3.75 3 3.75-3.75 3.75 3.75"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9 9.563V9a3 3 0 0 1 6 0v.563m-6 0v5.874a3 3 0 0 0 6 0V9.563"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M6 12 3.269 3.125A59.769 59.769 0 0 1 21.485 12 59.768 59.768 0 0 1 3.27 20.875L6 12Zm0 0h12.75"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h12A2.25 2.25 0 0 0 20.25 14.25V3M3.75 14.25v4.5A2.25 2.25 0 0 0 6 21h12a2.25 2.25 0 0 0 2.25-2.25v-4.5m-16.5 0h16.5"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H21a2.25 2.25 0 0 0 2.25-2.25V5.25A2.25 2.25 0 0 0 21 3H3a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 3 21h3.75m13.5-6.75a5.25 5.25 0 0 0-10.5 0 .75.75 0 0 1-1.5 0a6.75 6.75 0 1 1 13.5 0a.75.75 0 0 1-1.5 0Z"
          />
        </svg>
      );
      break;
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M3.75 21v-18a2.25 2.25 0 0 1 2.25-2.25h12A2.25 2.25 0 0 1 20.25 3v18M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      icon = (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M13.5 21v-3.375A4.5 4.5 0 0 0 9 13.5h-3a4.5 4.5 0 0 0-4.5 4.5v3.375M13.5 21h-3v-3.375a4.5 4.5 0 0 1 4.5-4.5h1.5a4.5 4.5 0 0 1 4.5 4.5v3.375h-3M13.5 21v-3.375A4.5 4.5 0 0 0 9 13.5h-3m3 0V3"
          />
        </svg>
      );
      break;
